...
class Beheerders(models.Model):
    beheerder_id = models.AutoField(primary_key=True, blank=True, null=True)
...
class BeheerderCustomuser(models.Model):
    password = models.CharField(max_length=128)
    last_login = models.DateTimeField(blank=True, null=True)
    is_superuser = models.BooleanField()
    username = models.CharField(unique=True, max_length=150)
    ...
    class Meta:
        managed = False
        db_table = 'beheerder_customuser'


class BeheerderCustomuserGroups(models.Model):
    customuser = models.ForeignKey(BeheerderCustomuser, models.DO_NOTHING)
    group = models.ForeignKey(AuthGroup, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'beheerder_customuser_groups'
        unique_together = (('customuser', 'group'),)


class BeheerderCustomuserUserPermissions(models.Model):
    customuser = models.ForeignKey(BeheerderCustomuser, models.DO_NOTHING)
    permission = models.ForeignKey(AuthPermission, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'beheerder_customuser_user_permissions'
