...
class Deelnames(models.Model):
    ...
    ervaringsdeskundige = models.ForeignKey('ErvaringsdeskundigeUser', models.DO_NOTHING)
...
class MedewerkersOrganisatie(models.Model):
    medewerker_id = models.AutoField(primary_key=True, blank=True, null=True)
...
class Organisaties(models.Model):
    organisatie_id = models.AutoField(primary_key=True, blank=True, null=True)
...
class Statuscodes(models.Model):
    status_id = models.AutoField(primary_key=True, blank=True, null=True)
    omschrijving = models.TextField()
...
class BeheerderBeheerders(models.Model):
    password = models.CharField(max_length=128)
    last_login = models.DateTimeField(blank=True, null=True)
    is_superuser = models.BooleanField()
    username = models.CharField(unique=True, max_length=150)
    ...
    class Meta:
        managed = False
        db_table = 'beheerder_beheerders'


class BeheerderBeheerdersGroups(models.Model):
    customuser = models.ForeignKey(BeheerderBeheerders, models.DO_NOTHING)
    group = models.ForeignKey(AuthGroup, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'beheerder_beheerders_groups'
        unique_together = (('customuser', 'group'),)


class BeheerderBeheerdersUserPermissions(models.Model):
    customuser = models.ForeignKey(BeheerderBeheerders, models.DO_NOTHING)
    permission = models.ForeignKey(AuthPermission, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'beheerder_beheerders_user_permissions'
...
class ErvaringsdeskundigeUserGroups(models.Model):
    ervaringsdeskundige = models.ForeignKey(ErvaringsdeskundigeUser, models.DO_NOTHING)
    group = models.ForeignKey(AuthGroup, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'ervaringsdeskundige_user_groups'
        unique_together = (('ervaringsdeskundige', 'group'),)


class ErvaringsdeskundigeUserUserPermissions(models.Model):
    ervaringsdeskundige = models.ForeignKey(ErvaringsdeskundigeUser, models.DO_NOTHING)
    permission = models.ForeignKey(AuthPermission, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'ervaringsdeskundige_user_user_permissions'
